...
import (
	...
	zipkinhttp2 "github.com/openzipkin/zipkin-go/reporter/http"
	"log"
	"net/http"
	"net/http/httptest"
	"time"
...
func main() {
	...
	reporter := zipkinhttp2.NewReporter("http://localhost:9411/api/v2/spans")
	defer reporter.Close()

	// create our local service endpoint
	endpoint, err := zipkin.NewEndpoint("myService", "192.168.1.33:9411")
	if err != nil {
